...
#define MAVLINK_MSG_ID_PARAM_VALUE 127


typedef struct __mavlink_param_value_t {
 float param_value; /*<  float*/
 uint16_t param_count; /*<  uint16_t*/
 uint16_t param_index; /*<  uint16_t*/
 char param_id[16]; /*<  char_array*/
 uint8_t param_type; /*<  uint8_t*/
} mavlink_param_value_t;

#define MAVLINK_MSG_ID_PARAM_VALUE_LEN 25
#define MAVLINK_MSG_ID_PARAM_VALUE_MIN_LEN 25
#define MAVLINK_MSG_ID_127_LEN 25
#define MAVLINK_MSG_ID_127_MIN_LEN 25

#define MAVLINK_MSG_ID_PARAM_VALUE_CRC 220
#define MAVLINK_MSG_ID_127_CRC 220
 ...
 * @param param_count  uint16_t
 * @param param_index  uint16_t
 * @param param_id  char_array
 * @param param_type  uint8_t
...
static inline uint16_t mavlink_msg_param_value_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float param_value, uint16_t param_count, uint16_t param_index, const char *param_id, uint8_t param_type)
{
...
{
    return mavlink_msg_param_value_pack(system_id, component_id, msg, param_value->param_value, param_value->param_count, param_value->param_index, param_value->param_id, param_value->param_type);
}
...
{
    return mavlink_msg_param_value_pack_chan(system_id, component_id, chan, msg, param_value->param_value, param_value->param_count, param_value->param_index, param_value->param_id, param_value->param_type);
}
...
{
    return mavlink_msg_param_value_pack_status(system_id, component_id, _status, msg,  param_value->param_value, param_value->param_count, param_value->param_index, param_value->param_id, param_value->param_type);
}
...
static inline void mavlink_msg_param_value_send(mavlink_channel_t chan, float param_value, uint16_t param_count, uint16_t param_index, const char *param_id, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_VALUE_LEN];
    _mav_put_float(buf, 0, param_value);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_value_send(chan, param_value->param_value, param_value->param_count, param_value->param_index, param_value->param_id, param_value->param_type);
#else
 ...
 */
static inline void mavlink_msg_param_value_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float param_value, uint16_t param_count, uint16_t param_index, const char *param_id, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
