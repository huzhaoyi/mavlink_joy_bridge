...
typedef struct __mavlink_serial_control_t {
 uint32_t baudrate; /*<  uint32_t*/
 uint16_t timeout; /*<  timeout*/
 uint8_t device; /*<  uint8_t*/
 uint8_t flags; /*<  uint8_t*/
 uint8_t count; /*<  uint8_t*/
 uint8_t data[70]; /*<  uint8_t_array*/
 ...
 *
 * @param baudrate  uint32_t
 * @param timeout  timeout
 * @param device  uint8_t
 * @param flags  uint8_t
 * @param count  uint8_t
 * @param data  uint8_t_array
...
static inline uint16_t mavlink_msg_serial_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t baudrate, uint16_t timeout, uint8_t device, uint8_t flags, uint8_t count, const uint8_t *data)
{
...
{
    return mavlink_msg_serial_control_pack(system_id, component_id, msg, serial_control->baudrate, serial_control->timeout, serial_control->device, serial_control->flags, serial_control->count, serial_control->data);
}
...
{
    return mavlink_msg_serial_control_pack_chan(system_id, component_id, chan, msg, serial_control->baudrate, serial_control->timeout, serial_control->device, serial_control->flags, serial_control->count, serial_control->data);
}
...
{
    return mavlink_msg_serial_control_pack_status(system_id, component_id, _status, msg,  serial_control->baudrate, serial_control->timeout, serial_control->device, serial_control->flags, serial_control->count, serial_control->data);
}
...
static inline void mavlink_msg_serial_control_send(mavlink_channel_t chan, uint32_t baudrate, uint16_t timeout, uint8_t device, uint8_t flags, uint8_t count, const uint8_t *data)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SERIAL_CONTROL_LEN];
    _mav_put_uint32_t(buf, 0, baudrate);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_serial_control_send(chan, serial_control->baudrate, serial_control->timeout, serial_control->device, serial_control->flags, serial_control->count, serial_control->data);
#else
 ...
 */
static inline void mavlink_msg_serial_control_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t baudrate, uint16_t timeout, uint8_t device, uint8_t flags, uint8_t count, const uint8_t *data)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
