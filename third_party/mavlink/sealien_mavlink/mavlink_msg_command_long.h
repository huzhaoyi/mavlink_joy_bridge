...
#include <mavlink.h>
#define MAVLINK_MSG_ID_COMMAND_LONG 129
...
typedef struct __mavlink_command_long_t {
 ...
 float param6; /*<  float*/
 float param7; /*<  float*/
 uint16_t command; /*<  uint16_t*/
 uint8_t target_system; /*<  target_system*/
 uint8_t target_component; /*<  uint8_t*/
 uint8_t confirmation; /*<  uint8_t*/
} mavlink_command_long_t;

#define MAVLINK_MSG_ID_COMMAND_LONG_LEN 33
#define MAVLINK_MSG_ID_COMMAND_LONG_MIN_LEN 33
#define MAVLINK_MSG_ID_129_LEN 33
#define MAVLINK_MSG_ID_129_MIN_LEN 33

#define MAVLINK_MSG_ID_COMMAND_LONG_CRC 152
#define MAVLINK_MSG_ID_129_CRC 152
 ...
 * @param param6  float
 * @param param7  float
 * @param command  uint16_t
 * @param target_system  target_system
 * @param target_component  uint8_t
 * @param confirmation  uint8_t
...
{
    return mavlink_msg_command_long_pack(system_id, component_id, msg, command_long->param1, command_long->param2, command_long->param3, command_long->param4, command_long->param5, command_long->param6, command_long->param7, command_long->command, command_long->target_system, command_long->target_component, command_long->confirmation);
}
...
static inline void mavlink_msg_command_long_send(mavlink_channel_t chan, float param1, float param2, float param3, float param4, float param5, float param6, float param7, uint16_t command, uint8_t target_system, uint8_t target_component, uint8_t confirmation)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_COMMAND_LONG_LEN];
    _mav_put_float(buf, 0, param1);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_command_long_send(chan, command_long->param1, command_long->param2, command_long->param3, command_long->param4, command_long->param5, command_long->param6, command_long->param7, command_long->command, command_long->target_system, command_long->target_component, command_long->confirmation);
#else
 ...
 */
static inline void mavlink_msg_command_long_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float param1, float param2, float param3, float param4, float param5, float param6, float param7, uint16_t command, uint8_t target_system, uint8_t target_component, uint8_t confirmation)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
